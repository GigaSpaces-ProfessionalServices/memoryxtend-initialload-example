...
export CLASSES_DIR="$PROJ_DIR/disttask/target/classes"

export MODEL_DIR="$PROJ_DIR/model/target/classes"

export MODEL_V2_DIR="$PROJ_DIR/modelv2/target/classes"

export CLASSPATH=$GIGA/lib/required/*

export CLASSPATH=$CLASSPATH:$MODEL_DIR

export CLASSPATH=$CLASSPATH:$MODEL_V2_DIR
...
$JAVA_HOME/bin/java -Xms1g -Xmx1g -classpath "$CLASSPATH" com.samples.disttask.TypeEvolutionExample
